...
final class $$ListsTableReferences
    extends BaseReferences<_$V1Database, $ListsTable, ListRecord> {
  ...
  _sectionsRefsTable(_$V1Database db) => MultiTypedResultKey.fromTable(
    db.sections,
...
class $$ListsTableFilterComposer extends Composer<_$V1Database, $ListsTable> {
...
class $$ListsTableOrderingComposer extends Composer<_$V1Database, $ListsTable> {
...
class $$ListsTableAnnotationComposer
    extends Composer<_$V1Database, $ListsTable> {
...
class $$ListsTableTableManager
    extends
        ...
        > {
  $$ListsTableTableManager(_$V1Database db, $ListsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
final class $$SectionsTableReferences
    extends BaseReferences<_$V1Database, $SectionsTable, SectionRecord> {
  $$SectionsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $ListsTable _listIdTable(_$V1Database db) =>
  ...
  _listItemsRefsTable(_$V1Database db) => MultiTypedResultKey.fromTable(
    db.listItems,
...
class $$SectionsTableFilterComposer
    extends Composer<_$V1Database, $SectionsTable> {
  $$SectionsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SectionsTableTableManager
    extends
        ...
        > {
  $$SectionsTableTableManager(_$V1Database db, $SectionsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
final class $$ListItemsTableReferences
    extends BaseReferences<_$V1Database, $ListItemsTable, ListItemRecord> {
  $$ListItemsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $SectionsTable _sectionIdTable(_$V1Database db) =>
...
class $$ListItemsTableFilterComposer
    extends Composer<_$V1Database, $ListItemsTable> {
  $$ListItemsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ListItemsTableTableManager
    extends
        ...
        > {
  $$ListItemsTableTableManager(_$V1Database db, $ListItemsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
